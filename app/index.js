...
function main() {
  ...
  PIXI.loader.add('ship', 'assets/ship.png').load((loader, resources) => {
    ...
    const background = makeBackground(scene.universe);
    ...
    function play() {
      ...
      background.x = viewport.width / 2 - scene.ship.x;
      background.y = viewport.height / 2 - scene.ship.y;
